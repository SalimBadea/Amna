...
import com.salem.amna.domain.use_case.addresses.NewAddressUseCase
...
class AddAddressViewModel @Inject constructor(
    ...
    private var _uiState: MutableStateFlow<AddAddressState> = MutableStateFlow(AddAddressState())
    ...
    private fun saveAddress() {
        newAddressUseCase(_uiState.value.toAddressBody()).onEach { result ->
